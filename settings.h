...
const char* ssid = "Sulthan raja";
const char* password = "sulthan3405";
...
volatile int  total_frames_config = 1800;  //  how many frames - length of movie in ms is total_frames x capture_interval
